            ...
            if x[i] >= sec["thickness"]["grid"][0] and x[i] <= sec["thickness"]["grid"][-1]:
                if "web" not in sec.keys():
                    ...
                    if "start_nd_arc" in sec.keys():
                        ...
                        tmp2[i]["segments"][0]["layup"][id_layer]["start"] = 0.0
                        tmp2[i]["segments"][0]["layup"][id_layer]["end"] = 1.0
                    ...
                    if "fiber_orientation" in sec.keys():
                        ...
                        tmp2[i]["segments"][0]["layup"][id_layer]["orientation"] = 0.0
                    id_layer = id_layer + 1
                else:
                        ...
                        if sec["material"] == materials[id_mat].name:
                            ...
                            if isinstance(materials[id_mat].E, float):  # Isotropic -> fill the web
                                ...
                                if "fiber_orientation" in sec.keys():
                                    ...
                                    tmp2[i]["segments"][id_web - 1]["layup"][id_layer_web_le[i]]["orientation"] = 0.0
                                    tmp2[i]["segments"][id_web + 1]["layup"][id_layer_web_te[i]]["orientation"] = 0.0
