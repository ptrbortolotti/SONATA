...
class FAST_IO():
    ...
    def plot_fast_out(self, cases, allinfo, alldata, flag_save_figs=False):
        '''
        ...
        for case in cases.keys():
            ...
            fig, axes = plt.subplots(len(plot_list),1, sharex=True, figsize=(12,8))
            myleg = []
            ...
            if flag_save_figs:
                plt.savefig('plot_temp/fig_' + str(case) + '.png')
