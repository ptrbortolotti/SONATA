...
class ExplComp_Hover_Analysis(ExplicitComponent):
    ...
    def compute(self, inputs, outputs):       
        ...
        savepath = filename_generator(directory = '/scratch/gu32kij', string='uh60a_hover', file_extension= '.pkl')
