...
from classPolar import Polar
from classAirfoil import Airfoil
from classMaterial import read_IAE37_materials
...
class Windturbine(object):
    ...
    def read_IAE37(self, yml, yml_schema):
        ...
        self.materials = {m.name:m for m in read_IAE37_materials(yml.get('materials'))}
