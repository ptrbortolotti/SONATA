...
from OCC.Core.BRepAdaptor import (BRepAdaptor_CompCurve,
                                  BRepAdaptor_Curve, BRepAdaptor_Curve2d,)
...
from OCC.Core.BRepTools import BRepTools_WireExplorer, breptools_Read
...
from SONATA.cbm.topo.utils import (Pnt2dLst_to_npArray, Polygon_orientation,
                                   PolygonArea,
                                   point2d_list_to_TColgp_Array1OfPnt2d,
                                   point2d_list_to_TColgp_HArray1OfPnt2d,
                                   unique_rows,)
from SONATA.cbm.topo.wire_utils import (NbEdges_in_wire, Unique_EdgeLst,
                                        Wire_Orientation,
                                        build_wire_from_BSplineLst,
                                        discretize_wire, rotate_wire,
                                        translate_wire,)
